...
# data
swbd1_dir=/mnt/lustre/sjtu/shared/data/asr/rawdata/SWBD1
eval2000_dir="/mnt/lustre/sjtu/shared/data/asr/rawdata/SWBD1/audio/hub5e_00 /mnt/lustre/sjtu/shared/data/asr/rawdata/SWBD1/audio/hub5e_00/trans"
...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ]; then
    ...
    local/swbd1_data_prep.sh ${swbd1_dir}/swb1
